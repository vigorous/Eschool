...
package com.haopai.controller.system.login;
...
import com.haopai.entity.system.Role;
...
public class LoginController extends BaseController {
	...
	public ModelAndView toLogin() throws Exception {
		...
		pd.put("SYSNAME", SysUtil.SYSTEM_NAME); // 读取系统名称
...
//					mv.addObject("strXML", strXML);
	...
	public String tab() {
		System.out.println("tab.do action ");
