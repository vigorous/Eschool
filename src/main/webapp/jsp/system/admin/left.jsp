													...
													<c:choose>
														<c:when test="${not empty sub.MENU_URL}">
															<li id="z${sub.MENU_ID }" class="">
																<%-- <a href="${sub.MENU_URL }" target="mainFrame" onclick="siMenu('z${sub.MENU_ID }','lm${sub.MENU_ID }','${sub.MENU_NAME}','${sub.MENU_URL}')">
																	<i class="menu-icon fa fa-caret-right"></i>
																	${sub.MENU_NAME }
																</a> --%>
																<a href="javascript:;" target="mainFrame" onclick="siMenu('z${sub.MENU_ID }','lm${sub.MENU_ID }','${sub.MENU_NAME}','${sub.MENU_URL}')">
																	<i class="menu-icon fa fa-caret-right"></i>
																	${sub.MENU_NAME }
																</a>
																<b class="arrow"></b>
