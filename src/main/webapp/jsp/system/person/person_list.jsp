	...
	<div class="page-content">
		<div class="row">
			<div class="col-xs-12">
				...
				<!-- 查询  -->
				<form class="form-horizontal" role="form" action="person/list.do" method="post" name="Form" id="Form">
								...
								<c:forEach items="${varList}" var="var" varStatus="vs">
									<tr>
										<td class="center" style="width:30px;">
											<label class="pos-rel">
												<input type='checkbox' class="ace" name='ids' value="${var.PERSON_ID}" />
												<span class="lbl"></span>
											</label>
										</td>
										...
										<td class="center" style="width:120px;">
											...
											<div class="hidden-sm hidden-xs btn-group">
												...
												<c:if test="${QX.edit == 1 }">
													<a title="编辑" onclick="edit('${var.PERSON_ID}');" class="btn btn-mini btn-success">
														<i class="ace-icon fa fa-edit"></i>
													</a>
												</c:if>
												<c:if test="${QX.del == 1 }">
													<a title="删除" onclick="del('${var.PERSON_ID}');" class="btn btn-mini btn-danger">
													...
													<c:otherwise>
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<c:if test="${QX.edit == 1 }">
																	<li>
																		<a href="javascript:edit('${var.PERSON_ID}');" class="tooltip-success" data-rel="tooltip" title="编辑">
																			<span class="green">
																...
																<c:if test="${QX.del == 1 }">
																	<li>
																		<a href="javascript:del('${var.PERSON_ID}');" class="tooltip-error" data-rel="tooltip" title="删除">
																			<span class="red">
