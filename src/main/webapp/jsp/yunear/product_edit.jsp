...
<body>
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<!-- form -->
							<form class="form-horizontal" role="form" action="product/${msg }.do" name="Form1" id="Form1" method="post">
								...
								<div id="zhongxin">
									...
									<div class="form-group" style="text-align: center">
										...
										<!-- <a class="btn btn-mini btn-danger" onclick="closeWin();">取消</a> -->
	...
	<!-- /.main-container -->
		...
		<script type="text/javascript">
			...
			/* function closeWin(){
				//layer.alert('11');
				//layer.alert(parent.name);
				//当你在iframe页面关闭自身时
				//layer.alert(window.name);
				//layer.alert("关闭窗口");
